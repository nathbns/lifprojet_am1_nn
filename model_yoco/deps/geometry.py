"""
Implémentation de l'algorithme de Bentley-Ottmann pour l'intersection de segments.
Algorithme standard de géométrie computationnelle pour la détection d'intersections
de segments de droites en temps O((n+k) log n) où n est le nombre de segments
et k le nombre d'intersections.

Références:
- Bentley, J. L., & Ottmann, T. A. (1979). "Algorithms for reporting and counting
  geometric intersections." IEEE Transactions on computers, 100(9), 643-647.
